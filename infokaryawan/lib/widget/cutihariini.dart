...
class CutiHariini extends StatefulWidget {
  @override
  _CutiHariiniState createState() => _CutiHariiniState();
}

class _CutiHariiniState extends State<CutiHariini> {
  @override
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.all(20),
      child: StreamBuilder<QuerySnapshot>(
          stream: HitFirebase().GetDataCutiKaryawanTanggalSekarang(),
          builder: (_, snapshot){
            if(snapshot.hasData){
